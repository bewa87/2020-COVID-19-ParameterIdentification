...
population_us      = 327350000; % Statista.com (2018)
N                  = population_us;

% Step 1.2: Load Infected Cases

[infected1,infected2] = textread('US-Infected.csv','%s;%f','delimiter',';');
infected2             = infected2(end:-1:1);
dates                 = (1:1:length(infected2))';

% Step 1.3: Load Recovered Cases

[recovered1,recovered2] = textread('US-Recovered.csv','%s;%f','delimiter',';');
recovered2              = recovered2(end:-1:1);

% Step 1.4: Load Dead Cases

[dead1, dead2] = textread('US-Dead.csv','%s;%f','delimiter',';');
dead2          = dead2(end:-1:1);
...
lt01 = title("United States: People vs. Dates", "fontsize", 14);
...
lt02 = title("United States: Transfer Rates vs. Dates", "fontsize", 14);
...
lt03 = title("United States: Alpha vs. Dates", "fontsize", 14);
...
ylim([0.0 0.4]);
lt04 = title("United States: Beta vs. Dates", "fontsize", 14);
